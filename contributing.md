# About this project
This is a new project for any code igniter developer , the aim is to create a super scalable news website  tongether , will be using a template  in zip . 

## Code igniter details
